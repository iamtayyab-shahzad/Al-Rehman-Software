...
const en = {
  ...
  menu_title: "Menu",
  menu_subtitle:
    "Official Al-rehman Fast Food menu — pizzas, burgers, pasta, broast, rolls, and family deals.",
...
const ur: Record<MessageKey, string> = {
  ...
  menu_title: "مینو",
  menu_subtitle:
    "الرحمان فاسٹ فوڈ کا سرکاری مینو — پیزا، برگر، پاستا، بروست، رولز اور فیملی ڈیلز۔",
